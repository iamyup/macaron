...
void WWDLayer::WordWho(){
	...
	for (int i = 0; i < 12; i++){
		...
		item[i] = MenuItemSprite::create(who[i], who[i],CC_CALLBACK_1( WWDLayer::whoEffect,this));
		item[i]->setTag(i + 1);
	}	
	for (int i = 0; i < 3; i++){
...
void WWDLayer::WordWhat(){


}

void WWDLayer::WordDo(){


}

void WWDLayer::whoEffect(Ref *sender){
